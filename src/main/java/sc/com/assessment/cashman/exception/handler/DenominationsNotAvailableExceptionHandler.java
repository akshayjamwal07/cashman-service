...
@ControllerAdvice
public class DenominationsNotAvailableExceptionHandler extends BaseExceptionHandler {

    private static final Logger LOG = getLogger(DenominationsNotAvailableExceptionHandler.class);

    @ExceptionHandler(DenomationsNotAvailableException.class)
    public ResponseEntity<ErrorResponse> defaultErrorHandler(final DenomationsNotAvailableException ex) {
